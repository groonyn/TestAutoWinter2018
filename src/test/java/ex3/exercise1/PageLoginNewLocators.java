...
public class PageLoginNewLocators {
    ...
    public void loginTest() {
        ...
        WebElement element = driver.findElement(By.xpath("//*[contains(text(),'Piter Chailovskii')]"));
        ...
        assertTrue(driver.findElement(By.cssSelector(".main-txt.text-center")).isDisplayed());
    }
}
